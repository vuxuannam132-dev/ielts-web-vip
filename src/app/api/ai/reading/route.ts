...
import { evaluateReading } from "@/lib/ai/readingReview";
...
export async function POST(req: NextRequest) {
    try {
        ...
        // Call AI Reading Evaluation
        const evaluation = await evaluateReading(user.id, { questions, userAnswers }, useAdvancedModel);
