                ...
                <div className="fixed inset-0 bg-slate-900/50 flex items-center justify-center p-4 z-50">
                    <div className="bg-white rounded-2xl w-full max-w-2xl overflow-hidden shadow-2xl">
                        <div className="p-4 border-b border-slate-100 flex items-center justify-between bg-slate-50">
                            <h3 className="font-bold text-slate-800 flex items-center gap-2"><Sparkles className="h-5 w-5 text-violet-600"/> Nhập Liệu Thông Minh (AI)</h3>
                        ...
                        <div className="p-6 relative">
                            {isParsingAI && (
                                <div className="absolute inset-0 z-10 bg-white/80 backdrop-blur-sm flex flex-col items-center justify-center rounded-b-2xl">
                                    ...
                                    <p className="text-violet-700 font-semibold animate-pulse text-lg">Thầy cô vui lòng chờ AI phân tích và up bài...</p>
